...
public class TransactionWriteSinkExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 类Unix系统的临时文件夹在/tmp下
        // Windows用户需要修改这个目录
        String preCommitPath = "D:\\temp\\flink-sink-precommit";
        String commitedPath = "D:\\temp\\flink-sink-commited";
    ...
    public static class TwoPhaseFileSink extends TwoPhaseCommitSinkFunction<Tuple2<String, Integer>, String, Void> {
        ...
        public String beginTransaction() throws Exception {
            ...
            Path preCommitFilePath = Paths.get(preCommitPath + "/" + fileName.replaceAll(":",""));
            // 创建一个存储本次事务的文件
